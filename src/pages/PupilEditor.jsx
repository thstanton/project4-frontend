...
export default function PupilEditor() {
  ...
  const finishModalText =
    "You will not be able to make more changes. Are you sure?";
    ...
    <div>
      {context && body && wordbanks && (
        <>
          ...
          <div>
            <JotterEditor body={body} setBody={setBody} complete={complete} />
          </div>
          ...
          <div className="flex flex-row gap-1.5">
            ...
            <button
              onClick={handleSave}
              className={complete ? "btn btn-disabled" : "btn"}
            >
              Save
            </button>
            <button
